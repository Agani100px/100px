...
export const metadata: Metadata = {
  ...
  description: "Terms & Conditions for 100px Photography - Read our terms of service and booking policies",
}

export default async function TermsConditionsPage() {
  const page = await fetchWordPressPage('terms-conditions')
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <AnimatedSection delay={0.1}>
            <h1 
              ...
              style={{ fontSize: '54px', fontWeight: 400, lineHeight: '54px' }}
