...
export const metadata: Metadata = {
  ...
  description: "Privacy Policy for 100px Photography - Learn how we collect, use, and protect your personal information",
}

export default async function PrivacyPolicyPage() {
  const page = await fetchWordPressPage('privacy-policy')
